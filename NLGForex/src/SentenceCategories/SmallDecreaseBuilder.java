...
public class SmallDecreaseBuilder implements BuilderInterface {
	...
	public ArrayList <String> sentences() {
		...
		for (int loop = 0; loop < fg.getNumRandomS(); loop ++) {
			...
			sentence = um.randomSentence (4) +"At the end of trading on " + date + um.randomSentence(1) + tempSrc + " made minor loses on the " + code;
			sentence2 = "Following " + date + um.randomSentence(4) + " slow depreciation against the " + code + um.randomSentence(4);
		...
		for (int loop = 0; loop < fg.getNumRandomS(); loop ++) {
			...
			temp  = begin[rand] + date + " the " + tempSrc + " made minor loses on the " + 
			code;
			temp2 = begin[rand] + date + " the " + tempSrc +" continues its' slow depreciation against " + code;
			temp3 = begin [rand] + date + " the " + tempSrc + " has moved a small amount from " + rateHist + 
			" to " + rate + " regarding the " + code;
			temp4  = begin[rand] + date + " the " + tempSrc + " made minor loses on the " + 
			code + end[randEnd];
			temp5 = begin[rand] + date + tempSrc + " has been in a slow decline concerning the " + code + end[randEnd];
			temp6 = begin [rand] + date + " the " + tempSrc + " has decreased a small amount from " + rateHist + 
					" to " + rate + " in its' market with " + code + end[randEnd];
